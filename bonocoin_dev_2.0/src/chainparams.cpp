...
{
    const char* pszTimestamp = "Making alternative coin called BONO by team3 of class4";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1647232200, 2190951, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa8df5cf90d84e75f874c7a5e23982ce5b6a08be329787198d4bdd9d29182f170"));
        assert(genesis.hashMerkleRoot == uint256S("0x6e521af091fd9b3ddea11ba61ce5c86010d08548f3bdf6600f8fb317b24860a1"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.kigacoin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.kigacointools.com", tr  ue);
        // vSeeds.emplace_back("dnsseed.kigacoinpool.org", true);
        // vSeeds.emplace_back("dnsseed.koin-project.com", false);
        vSeeds.clear();
        vSeeds.emplace_back("", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);  // B = 25 or 26
        ...
        checkpointData = (CCheckpointData) {
            {
                {     0, uint256S("0xde0bc9e62461efb7cb25b3dfadef8e3b9d032872b04d99bf121793691774161d")},
                /*
        ...
        chainTxData = ChainTxData{
            ...
            1617604141, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1647234000, 845751, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd85c51d6517b21385577ab0f45bf9468e02334332d56048ef339f018134fa029"));
        assert(genesis.hashMerkleRoot == uint256S("0x6e521af091fd9b3ddea11ba61ce5c86010d08548f3bdf6600f8fb317b24860a1"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // vSeeds.emplace_back("testnet-seed.kigacointools.com", true);
        // vSeeds.emplace_back("seed-b.kigacoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("13f611d597e568ed379a03bd7d8b3f7b3be0677875c5abf7c02d3e903963cf6f")},
