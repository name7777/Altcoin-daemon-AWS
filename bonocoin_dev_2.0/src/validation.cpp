...
#if defined(NDEBUG)
# error "Bonocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bonocoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BNC additional fees, %d delta bytes\n",
