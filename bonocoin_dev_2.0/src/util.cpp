...
const char * const BITCOIN_CONF_FILENAME = "bonocoin.conf";
const char * const BITCOIN_PID_FILENAME = "bonocoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bonocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bonocoin";
#else
    // Unix
    return pathRet / ".bonocoin";
#endif
#endif
}
