...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bonocoin-project/bonocoin>";
    const std::string URL_WEBSITE = "<https://bonocoin.org>";
