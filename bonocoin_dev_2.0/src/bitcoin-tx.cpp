...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bonocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bonocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bonocoin transaction") + "\n" +
              "  bonocoin-tx [options] -create [commands]   " + _("Create hex-encoded bonocoin transaction") + "\n" +
              "\n";
